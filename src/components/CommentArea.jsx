...
class CommentArea extends Component {
  state = {
    ...
    loading: true, // true mentre sto caricando
  ...
  componentDidMount() {
    // appena il componente parte, carico i commenti
    this.getComments()
  }

  componentDidUpdate(prevProps) {
    // se cambia asin (clicco un altro libro), ricarico i commenti del nuovo libro
